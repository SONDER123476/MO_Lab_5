...
static std::ostream& operator<<(std::ostream& steram, const mat_mn& v)
{
	...
	for ( size_t i = 0; i < v.size() - 1; i++)steram << v[i] << ",\n";
...
static bool operator<=(const mat_mn& a, const double& x)
{
...
/// <summary>
/// Ïðîâåðÿåò ñîâìåñòíîñòü ÑËÀÓ âèäà Ax = b. Èñïîëüçóåòñÿ òåîðåìà Êðîíåêåðà-Êàïåëëè 
/// </summary>
/// <param name="A"></param>
/// <param name="b"></param>
/// <returns>0 - íåò ðåøåíèé, 1 - îäíî ðåøåíèå, 2 - áåñêîíå÷íîå ìíîæåñòâîå ðåøåíèé</returns>
